...
global.timezone  = process.env.TIME_ZONE || 'Asia/Anuradhapura'
...
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;ReaganSmash
",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'mr madhuwa',
  botbgm: process.env.BOT_BGM || 'true',
  ownername:  process.env.OWNER_NAME || `mr madhuwa`,
